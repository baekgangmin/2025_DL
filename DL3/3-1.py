...
def build_model1(input_shape):
    model = layers.Conv2D(1, (3,3), strides=(1,1),  padding='same',
                          activation="relu", 
...
def build_model2(input_shape):
    model = Sequential([layers.Conv2D(4, (3,3), strides=(1,1),  padding='same'
                                      , input_shape=input_shape[1:]),
                        layers.Conv2D(4, (3,3), strides=(1,1),  padding='same')])
...
def build_model3(input_shape):
    ...
    model.add(layers.Conv2D(2, (3,3), strides=(1,1),  padding='same', input_shape=input_shape[1:]))
    model.add(layers.Conv2D(4, (3,3), strides=(1,1),  padding='same'))
